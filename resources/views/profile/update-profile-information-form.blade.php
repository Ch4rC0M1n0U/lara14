<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="telUser" type="text" class="block w-full mt-1" wire:model="state.telUser" required autocomplete="telUser" />
            <x-input-error for="telUser" class="mt-2" />
        </div>
        <div class="col-span-6 sm:col-span-4">
            <x-label for="Matricule" value="{{ __('Matricule') }}" />
            <x-input id="Matricule" type="text" class="block w-full mt-1" wire:model="state.Matricule" required autocomplete="Matricule" />
