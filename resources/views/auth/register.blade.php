    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="services" class="block w-full mt-1" type="text" name="services" :value="old('services')" required autocomplete="services" />
            </div>

            <div class="mt-4">
                <x-label for="Matricule" value="{{ __('Matricule') }}" />
                <x-input id="Matricule" class="block w-full mt-1" type="text" name="Matricule" :value="old('Matricule')" required autocomplete="Matricule" />
            </div>

            <div class="mt-4">
                <x-label for="telUser" value="{{ __('Téléphone') }}" />
                <x-input id="telUser" class="block w-full mt-1" type="text" name="telUser" :value="old('telUser')" required autocomplete="telUser" />
            </div>
